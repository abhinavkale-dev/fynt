...
function assertValidPayload(
  payload: unknown,
): asserts payload is ExecutionStreamTokenPayload {
...
export function signExecutionStreamToken(
  input: SignExecutionStreamTokenInput,
  secret: string,
): string {
...
export function verifyExecutionStreamToken(
  token: string,
  secret: string,
  now: Date = new Date(),
