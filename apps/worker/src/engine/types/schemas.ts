...
const webhookTriggerNodeDataSchema = z
  .object({
  ...
  .passthrough();
const cronTriggerNodeDataSchema = z
  .object({
    schedule: z
      .enum(["every_5_minutes", "hourly", "daily", "weekly"])
      .optional(),
...
const conditionNodeDataSchema = z
  ...
  .passthrough();
const delayNodeDataSchema = z
  .object({
    durationMs: z.number().positive().optional(),
    responseName: z.string().optional(),
  })
  .passthrough();
const logNodeDataSchema = z
  .object({
...
const httpNodeDataSchema = z
  ...
  .passthrough();
const githubNodeDataSchema = z
  .object({
    responseName: z.string().optional(),
    credentialId: z.string().optional(),
    operation: z
      .enum(["create_issue", "create_comment", "get_issue"])
      .optional(),
...
const aiNodeDataSchema = z
  ...
  .passthrough();
const manualTriggerNodeDataSchema = z
  .object({
    payload: z.record(z.unknown()).optional(),
  })
  .passthrough();
const transformNodeDataSchema = z
  .object({
    expression: z.string().optional(),
    responseName: z.string().optional(),
  })
  .passthrough();
const filterNodeDataSchema = z
  .object({
    expression: z.string().optional(),
