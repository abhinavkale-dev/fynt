...
async function mutateLockIfOwned(
  workflowRunId: string,
  workerId: string,
  mutate: (transaction: ReturnType<typeof redis.multi>) => void,
): Promise<boolean> {
...
export async function releaseLock(
  ...
  return withRedisFallback(
    "worker-lock:release",
    async () =>
      mutateLockIfOwned(workflowRunId, workerId, (transaction) => {
