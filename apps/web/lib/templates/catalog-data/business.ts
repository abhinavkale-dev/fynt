...
export const BUSINESS_TEMPLATES: Partial<WorkflowTemplate>[] = [
    ...
    requiredBindings: [
      {
        platform: "notion",
        nodeIds: ["np-notion"],
        description: "Notion credential for database reads",
      },
      {
        platform: "slack",
        nodeIds: ["np-slack"],
        description: "Slack credential for updates",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"message":"Fetched recent Notion entries at {np-manual.triggeredAt}"}',
        },
      },
      {
        id: "np-slack",
  ...
  },
  {
    ...
    description:
      "Score backlog items with OpenAI and route high-priority work into GitHub.",
    category: "business",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["nb-openai"],
        description: "OpenAI credential for scoring",
      },
      {
        platform: "github",
        nodeIds: ["nb-github"],
      ...
      },
      {
        platform: "slack",
        nodeIds: ["nb-slack"],
        description: "Slack credential for notifications",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"items":[{"title":"Fix onboarding edge cases","impact":"high"},{"title":"Improve analytics dashboard","impact":"medium"}],"generatedAt":"{nb-cron.triggeredAt}"}',
        },
      },
      {
        id: "nb-openai",
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"title":"Backlog follow-up","backlog":{json nbBacklog}}',
        },
      },
      {
        id: "nb-condition",
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Backlog routing outcome: {nbRoute.route}. Priority signal: {nbScore.data}",
        },
      },
    ],
    edges: [
