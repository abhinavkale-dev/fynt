...
export const AI_AUTOMATION_TEMPLATES: Partial<WorkflowTemplate>[] = [
  {
    ...
    description:
      "Collect daily metrics, summarize with OpenAI, archive a report in Notion, and notify Slack + Discord.",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["digest-gemini"],
        description: "OpenAI credential for summarization",
      },
      {
        platform: "notion",
        nodeIds: ["digest-notion"],
        description: "Notion credential for report archive",
      },
      {
        platform: "slack",
        nodeIds: ["digest-slack"],
        description: "Slack credential for posting",
      },
      {
        platform: "discord",
        nodeIds: ["digest-discord"],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"summary":"Create a concise KPI digest from these metrics.","summaryPrompt":"Create a concise KPI digest from these metrics.","metrics":{json digestMetrics},"runAt":"{digest-cron.triggeredAt}"}',
        },
      },
      {
        id: "digest-gemini",
        ...
        data: {
          ...
          model: "",
          prompt:
            "{digestContext.data.summaryPrompt}\n{json digestContext.data.metrics}",
          temperature: 0.2,
        },
      },
      {
        ...
        data: {
          ...
          databaseId: "",
          propertiesTemplate:
            '{"Name":{"title":[{"text":{"content":"Daily AI Digest {digest-cron.triggeredAt}"}}]}}',
          childrenTemplate:
            '[{"object":"block","type":"paragraph","paragraph":{"rich_text":[{"type":"text","text":{"content":{json digestSummary.data}}}]}}]',
        },
      },
      {
        id: "digest-slack",
  ...
  },
  {
    ...
    description:
      "Turn rough meeting notes into action items, archive them in Notion, and notify the team.",
    category: "ai-automation",
    difficulty: "beginner",
    ...
    requiredBindings: [
      {
        platform: "anthropic",
        nodeIds: ["meet-anthropic"],
        description: "Anthropic credential for note cleanup",
      },
      {
        platform: "notion",
        nodeIds: ["meet-notion"],
        description: "Notion credential for action-item archive",
      },
      {
        platform: "slack",
        nodeIds: ["meet-slack"],
        description: "Slack credential for team update",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          databaseId: "",
          propertiesTemplate:
            '{"Name":{"title":[{"text":{"content":"Meeting Actions {meet-manual.triggeredAt}"}}]}}',
          childrenTemplate:
            '[{"object":"block","type":"paragraph","paragraph":{"rich_text":[{"type":"text","text":{"content":{json meetingPayload.data.summary}}}]}}]',
        },
      },
      {
        id: "meet-slack",
  ...
  },
  {
    ...
    description:
      "Generate a quick research brief with OpenAI and distribute to Slack + Discord.",
    category: "ai-automation",
    difficulty: "beginner",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["qr-openai"],
        description: "OpenAI credential for research drafting",
      },
      {
        platform: "slack",
        nodeIds: ["qr-slack"],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Create a concise market update on workflow automation trends.",
          temperature: 0.3,
        },
      },
      {
  ...
  },
  {
    ...
    description:
      "Generate a content brief with OpenAI, archive it in Notion, and hand it off to Slack.",
    category: "ai-automation",
    difficulty: "intermediate",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["brief-openai"],
        description: "OpenAI credential for brief generation",
      },
      {
        platform: "notion",
        nodeIds: ["brief-notion"],
        description: "Notion credential for brief archive",
      },
      {
        platform: "slack",
        nodeIds: ["brief-slack"],
        description: "Slack credential for team handoff",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Write a concise launch content brief in plain text under 900 characters. Include audience, angle, CTA, and one risk note.",
          temperature: 0.4,
        },
      },
      {
        ...
        data: {
          ...
          expression:
            '{"title":"Content Brief","summary":{json contentBrief.data}}',
        },
      },
      {
        id: "brief-notion",
        ...
        data: {
          ...
          databaseId: "",
          propertiesTemplate:
            '{"Name":{"title":[{"text":{"content":"Content Brief {brief-manual.triggeredAt}"}}]}}',
          childrenTemplate:
            '[{"object":"block","type":"paragraph","paragraph":{"rich_text":[{"type":"text","text":{"content":{json briefPayload.data.summary}}}]}}]',
        },
      },
      {
        id: "brief-slack",
  ...
  },
  {
    ...
    description:
      "Pull from two HTTP sources, synthesize with OpenAI + Anthropic, then publish to Slack with a run log.",
    category: "ai-automation",
    difficulty: "advanced",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["ms-openai"],
        description: "OpenAI credential for first-pass synthesis",
      },
      {
        platform: "anthropic",
        nodeIds: ["ms-gemini"],
        description: "Anthropic credential for refinement",
      },
      {
        platform: "slack",
        nodeIds: ["ms-slack"],
        description: "Slack credential for final share",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Synthesize these sources into a unified draft: A={json sourceA}, B={json sourceB}",
          temperature: 0.2,
        },
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Improve this research brief and add key takeaways: {researchDraft.data}",
          temperature: 0.2,
        },
      },
      {
        ...
        data: {
          ...
          expression:
            '{"title":"Research Brief","summary":{json researchRefined.data}}',
        },
      },
      {
        id: "ms-slack",
  ...
  },
  {
    ...
    description:
      "Run multi-model governance checks and route pass/revise outcomes.",
    category: "ai-automation",
    difficulty: "advanced",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["gov-openai"],
        description: "OpenAI credential for first review",
      },
      {
        platform: "openai",
        nodeIds: ["gov-gemini"],
        description: "OpenAI credential for second review",
      },
      {
        platform: "anthropic",
        nodeIds: ["gov-anthropic"],
        description: "Anthropic credential for governance scoring",
      },
      {
        platform: "slack",
        nodeIds: ["gov-slack"],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "You are a strict governance reviewer. Evaluate the review below and reply with exactly one lowercase word: pass or revise. Do not add extra text.\n\nReview:\n{geminiReview.data}",
          temperature: 0,
        },
      },
      {
        ...
        data: {
          ...
          expression:
            '{"decision":"{govVerdict.data}","summary":{json geminiReview.data}}',
        },
      },
      {
        id: "gov-condition",
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Governance outcome: {govRoute.route}\n\nReview summary:\n{govResult.data.summary}",
        },
      },
      {
        id: "gov-log",
