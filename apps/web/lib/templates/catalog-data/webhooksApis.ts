...
export const WEBHOOKS_APIS_TEMPLATES: Partial<WorkflowTemplate>[] = [
  {
    ...
    description:
      "Convert inbound webhook incidents into GitHub issues and post updates to Slack.",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"title":"[{wh-webhook.payload.severity}] {wh-webhook.payload.service}","body":"Summary: {wh-webhook.payload.message}\\nOccurredAt: {wh-webhook.payload.occurredAt}"}',
        },
      },
      {
        id: "wh-github",
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Created issue #{createdIssue.issueNumber}: {issuePayload.data.title}",
        },
      },
      {
        id: "wh-log",
        ...
        data: {
          ...
          level: "info",
          message:
            "Issue creation workflow completed for {issuePayload.data.title}",
        },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    description:
      "Use webhook events + Anthropic triage to route urgent bug notifications.",
    category: "webhooks-apis",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          prompt:
            "Classify production bug urgency from this issue payload. Reply with exactly one lowercase word: high or normal. Do not add extra text.\n\nIssue payload:\n{json bugIssue}",
          temperature: 0,
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Bug triage route: {bugRoute.route} for issue {bug-webhook.payload.issueNumber}",
        },
      },
      {
        id: "bug-log",
        ...
        data: {
          ...
          level: "info",
          message:
            "Bug triage completed for issue {bug-webhook.payload.issueNumber} (route={bugRoute.route})",
        },
      },
    ],
    edges: [
