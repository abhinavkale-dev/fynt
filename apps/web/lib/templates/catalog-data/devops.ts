...
export const DEVOPS_TEMPLATES: Partial<WorkflowTemplate>[] = [
  {
    ...
    requiredBindings: [
      ...
      },
      {
        platform: "openai",
        nodeIds: ["rel-openai"],
        description: "OpenAI credential for release-note drafting",
      },
      {
        platform: "slack",
        nodeIds: ["rel-slack"],
        description: "Slack credential for release distribution",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"version":"{rel-webhook.payload.version}","issue":"{json releaseIssue}","summary":"Build release notes for version {rel-webhook.payload.version}"}',
        },
      },
      {
        id: "rel-openai",
        ...
        data: {
          ...
          model: "",
          systemPrompt:
            "You are a release manager. Draft concise release notes.",
          prompt:
            "Context: {json releaseContext}. Produce markdown release notes.",
          temperature: 0.2,
        },
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Release {rel-webhook.payload.version} notes ready:\n{releaseNotes.data}",
        },
      },
      {
        id: "rel-log",
    ...
    requiredBindings: [
      {
        platform: "anthropic",
        nodeIds: ["ir-ai"],
        description: "Anthropic credential for severity scoring",
      },
      {
        platform: "github",
        nodeIds: ["ir-gh"],
      ...
      },
      {
        platform: "slack",
        nodeIds: ["ir-slack"],
        description: "Slack credential for paging",
      },
      {
        platform: "discord",
        nodeIds: ["ir-discord"],
        description: "Discord credential for ops updates",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"service":"{ir-webhook.payload.service}","severity":"{ir-webhook.payload.severity}","summary":"{ir-webhook.payload.message}","occurredAt":"{ir-webhook.payload.occurredAt}"}',
        },
      },
      {
        id: "ir-ai",
        ...
        data: {
          ...
          prompt:
            "Incident data: {json incidentPayload}. Return critical or normal only.",
          temperature: 0,
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          level: "info",
          message:
            "Incident routed to normal handling for {incidentPayload.data.service}",
        },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    requiredBindings: [
      {
        platform: "slack",
        nodeIds: ["health-slack"],
        description: "Slack credential for unhealthy alerts",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"httpStatusCode":"{healthResponse.httpStatusCode}","state":"{healthResponse.httpStatusCode}","body":{json healthResponse}}',
        },
      },
      {
        id: "health-condition",
        ...
        data: {
          ...
          rulesJson:
            '[{"route":"unhealthy","operator":"not_equals","value":"200"}]',
