...
export const DATA_ETL_TEMPLATES: Partial<WorkflowTemplate>[] = [
  {
    ...
    description:
      "Route incoming webhook alerts to Slack or Discord based on severity.",
    ...
    requiredBindings: [
      ...
      },
      {
        platform: "discord",
        nodeIds: ["wdr-discord"],
        description: "Discord credential for standard alerts",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"severity":"{wdr-webhook.payload.severity}","service":"{wdr-webhook.payload.service}","message":"{wdr-webhook.payload.message}","occurredAt":"{wdr-webhook.payload.occurredAt}"}',
        },
      },
      {
        id: "wdr-condition",
        ...
        data: {
          ...
          defaultRoute: "normal",
          rulesJson:
            '[{"route":"urgent","operator":"contains","value":"high"}]',
      ...
      },
      {
        ...
        data: {
          ...
          level: "info",
          message:
            "Alert routed ({alertRoute.route}) for {alertPayload.data.service} with severity {alertPayload.data.severity}",
        },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    description:
      "Summarize webhook payloads with OpenAI and publish to Discord.",
    category: "webhooks-apis",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["ows-openai"],
        description: "OpenAI credential for summarization",
      },
      {
        platform: "discord",
        nodeIds: ["ows-discord"],
        description: "Discord credential for posting",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"event":{json ows-webhook.payload},"prompt":"Summarize this event in 3 concise bullet points."}',
        },
      },
      {
        id: "ows-openai",
  ...
  },
  {
    ...
    description:
      "Run scheduled health checks, summarize context with OpenAI, and route alerts.",
    category: "devops",
    difficulty: "intermediate",
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["coh-openai"],
        description: "OpenAI credential for health summaries",
      },
      {
        platform: "slack",
        nodeIds: ["coh-slack"],
        description: "Slack credential for alerts",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"httpStatusCode":"{cohResponse.httpStatusCode}","response":{json cohResponse},"prompt":"Summarize API health and give one action recommendation."}',
        },
      },
      {
        id: "coh-openai",
      ...
      },
      {
        ...
        data: {
          ...
          defaultRoute: "ok",
          rulesJson:
            '[{"route":"alert","operator":"not_equals","value":"200"}]',
      ...
      },
      {
        ...
        data: {
          ...
          level: "info",
          message:
            "Health workflow processed status {cohContext.data.httpStatusCode}",
        },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    description:
      "Read GitHub issues from webhook events and post AI-generated maintainer comments.",
    category: "devops",
    difficulty: "intermediate",
    ...
    requiredBindings: [
      ...
      },
      {
        platform: "openai",
        nodeIds: ["gic-openai"],
        description: "OpenAI credential for comment drafting",
      },
      {
        platform: "discord",
        nodeIds: ["gic-discord"],
        description: "Discord credential for notifications",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Draft a concise maintainer response for this issue: {json gicIssue.data}",
          temperature: 0.2,
        },
      },
      {
  ...
  },
  {
    ...
    description:
      "Generate a standup digest and distribute it across Discord and Slack.",
    category: "business",
    difficulty: "beginner",
    estimatedSetupMinutes: 5,
    ...
    requiredBindings: [
      {
        platform: "anthropic",
        nodeIds: ["asd-anthropic"],
        description: "Anthropic credential for digest generation",
      },
      {
        platform: "discord",
        nodeIds: ["asd-discord"],
      ...
      },
      {
        platform: "slack",
        nodeIds: ["asd-slack"],
        description: "Slack credential for posting",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Create a concise standup digest with priorities and blockers for today.",
          temperature: 0.2,
        },
      },
      {
  ...
  },
  {
    ...
    description:
      "Draft a policy with OpenAI, validate with Anthropic, then route pass/revise outcomes.",
    category: "business",
    difficulty: "intermediate",
    estimatedSetupMinutes: 8,
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["prr-openai"],
        description: "OpenAI credential for draft generation",
      },
      {
        platform: "anthropic",
        nodeIds: ["prr-anthropic"],
        description: "Anthropic credential for validation",
      },
      {
        platform: "slack",
        nodeIds: ["prr-slack"],
        description: "Slack credential for pass notifications",
      },
      {
        platform: "discord",
        nodeIds: ["prr-discord"],
        description: "Discord credential for revise notifications",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "You are a strict policy reviewer. Evaluate the policy below and reply with exactly one lowercase word: pass or revise. Do not add any extra text.\n\nPolicy:\n{prrDraft.data}",
          temperature: 0,
        },
      },
      {
        ...
        data: {
          ...
          expression:
            '{"decision":"{prrReview.data}","outcome":"Policy review outcome: {prrReview.data}","draft":{json prrDraft.data}}',
        },
      },
      {
        id: "prr-condition",
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Policy review outcome: {prrRoute.route}\n\nDraft:\n{prrDecision.data.draft}",
        },
      },
      {
        id: "prr-discord",
  ...
  },
  {
    ...
    description:
      "Fetch weekly trend data, summarize with Anthropic, and post to Discord.",
    category: "marketing",
    difficulty: "intermediate",
    estimatedSetupMinutes: 7,
    ...
    requiredBindings: [
      {
        platform: "anthropic",
        nodeIds: ["wtb-anthropic"],
        description: "Anthropic credential for trend summaries",
      },
      {
        platform: "discord",
        nodeIds: ["wtb-discord"],
        description: "Discord credential for publishing",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          expression:
            '{"trendData":{json wtbTrends},"prompt":"Create a weekly trend brief with top 5 insights."}',
        },
      },
      {
        id: "wtb-anthropic",
  ...
  },
  {
    ...
    description:
      "Repurpose a product update with OpenAI and publish to Discord + Slack.",
    category: "marketing",
    difficulty: "beginner",
    estimatedSetupMinutes: 5,
    ...
    requiredBindings: [
      {
        platform: "openai",
        nodeIds: ["crd-openai"],
        description: "OpenAI credential for repurposing",
      },
      {
        platform: "discord",
        nodeIds: ["crd-discord"],
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Repurpose this product update into short posts for Discord and Slack.",
          temperature: 0.3,
        },
      },
      {
        ...
        data: {
          ...
          expression:
            '{"discord":{json crdCopy.data},"slack":{json crdCopy.data}}',
        },
      },
      {
        id: "crd-discord",
  ...
  },
  {
    ...
    description:
      "Analyze release risk from GitHub issue context and route high/normal outcomes.",
    ...
    requiredBindings: [
      {
        platform: "github",
        nodeIds: ["rrc-github"],
        description: "GitHub credential for issue lookup",
      },
      {
        platform: "openai",
        nodeIds: ["rrc-openai"],
        description: "OpenAI credential for risk summary",
      },
      {
        platform: "anthropic",
        nodeIds: ["rrc-anthropic"],
        description: "Anthropic credential for risk class",
      },
      {
        platform: "slack",
        nodeIds: ["rrc-slack"],
        description: "Slack credential for high-risk alerts",
      },
      {
        platform: "discord",
        nodeIds: ["rrc-discord"],
        description: "Discord credential for normal notifications",
      },
    ],
    fieldRequirements: [
      {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "Summarize release risk factors from this issue: {json rrcIssue.data}",
          temperature: 0.1,
        },
      },
      {
        ...
        data: {
          ...
          model: "",
          prompt:
            "You are a strict release risk classifier. Analyze the summary below and reply with exactly one lowercase word: high or normal. Do not add extra text.\n\nSummary:\n{rrcSummary.data}",
          temperature: 0,
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          channel: "",
          message:
            "Release risk route: {rrcRoute.route} for issue #{rrcIssue.issueNumber}\n\nSummary:\n{rrcSummary.data}",
        },
      },
      {
        id: "rrc-discord",
