    ...
    navMainPlatform: [
      {
        ...
        icon: WorkflowsIcon,
        isActive:
          pathname === "/home" || pathname?.startsWith("/home/workflows"),
      },
      {
        title: "Credentials",
                  ...
                  <SidebarMenuButton asChild className="h-9">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 32 32"
                        xmlns="http://www.w3.org/2000/svg"
                        className="size-4 shrink-0 text-white/50 group-hover/menu-item:text-white transition-colors duration-150 ease"
                      >
                        <g fill="currentColor">
                      ...
                      <span className="text-sm text-white/50 group-hover/menu-item:text-white transition-colors duration-150 ease">
                        Proudly Open Source
                      </span>
                    </a>
                  </SidebarMenuButton>
