...
export function Topbar({
  ...
  return (
    <header className="h-14 shrink-0 border-b border-white/10 bg-[#414243] flex items-center px-4 gap-3">
        ...
        <BreadcrumbList>
          <BreadcrumbItem className="hover:text-white group">
            ...
            >
              ...
              <span className="text-white/50 group-hover:text-white transition-colors duration-150 ease">
                Personal
              </span>
            </BreadcrumbLink>
          </BreadcrumbItem>
