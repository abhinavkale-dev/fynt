          ...
          <Collapsible key={item.title} asChild defaultOpen={item.isActive}>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip={item.title}
                className="h-9 data-[active=true]:bg-white/10"
              >
                <Link
                ...
                >
                  ...
                  <span className="text-sm text-white/50 group-hover/menu-item:text-white group-data-[active=true]:text-white transition-colors duration-150 ease">
                    {item.title}
                  </span>
                </Link>
              </SidebarMenuButton>
