...
export const ExecutionsIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ size = 18, className, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
ExecutionsIcon.displayName = "ExecutionsIcon";
export const UpgradeIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ size = 18, className, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const CredentialsIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ size = 18, className, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
CredentialsIcon.displayName = "CredentialsIcon";
...
export const AnthropicIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
export const GeminiIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ size = 16, className, ...props }, ref) => (
    <svg
      ref={ref}
      aria-hidden="true"
...
export const LogoutIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ className, ...props }, ref) => (
    <motion.a
      href="/home"
      className="text-white rounded-[13px] px-[14px] h-9 text-sm font-medium flex items-center gap-2 transition-[background-color,transform] duration-150 ease focus:outline-none active:scale-[0.97] motion-reduce:transition-none"
      initial="idle"
      whileHover="hover"
    >
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={`text-white/80 group-hover:text-white transition-colors ${className ?? ""}`}
        {...props}
      >
        <path
          opacity="0.4"
