    ...
    pages: [
      {
        ...
        subtitle:
          "Collect daily metrics, summarize with AI, archive in Notion, and notify your team.",
      ...
      },
      {
        ...
        subtitle:
          "Pull from two sources, synthesize with AI models, then publish to Slack with a run log.",
        icon: ShieldCheck,
      ...
      },
      {
        ...
        subtitle:
          "Run multi-model governance checks and route pass/revise outcomes automatically.",
        icon: FolderKanban,
    ...
    pages: [
      {
        ...
        subtitle:
          "Score backlog items with AI and route high-priority work into GitHub automatically.",
        icon: FolderKanban,
      ...
      },
      {
        ...
        subtitle:
          "Read recent entries from Notion and publish a short summary to Slack.",
        icon: ShieldCheck,
      ...
      },
      {
        ...
        subtitle:
          "Route policy documents for AI-powered review and approval workflows.",
        icon: MessageSquareText,
    ...
    pages: [
      {
        ...
        subtitle:
          "Run scheduled health checks and route alerts based on response health.",
        icon: FolderKanban,
      ...
      },
      {
        ...
        subtitle:
          "Create release notes from GitHub issue context and publish to Slack with an audit log.",
        icon: ShieldCheck,
      ...
      },
      {
        ...
        subtitle:
          "Centralized incident intake with AI triage and multi-channel routing.",
        icon: MessageSquareText,
    ...
    pages: [
      {
        ...
        subtitle:
          "Generate social post ideas with AI and share to Slack and Discord.",
        icon: FolderKanban,
      ...
      },
      {
        ...
        subtitle:
          "Transform existing content into multiple formats using AI for different channels.",
        icon: MessageSquareText,
      ...
      },
      {
        ...
        subtitle:
          "Fetch campaign metrics weekly, summarize with AI, and post to Discord.",
        icon: ShieldCheck,
...
const CATEGORY_ICONS: Record<TemplateId, React.ReactNode> = {
  ...
  business: (
    ...
    >
      <g>
        <path
          d="M20 12V17C20 18.6569 18.6569 20 17 20H7C5.34315 20 4 18.6569 4 17V12"
          stroke="currentColor"
          strokeWidth="2"
        ...
        />
        <path
          d="M9.5002 4H14.5002M9.5002 4L8.93432 8.52703C8.70381 10.3711 10.1417 12 12.0002 12C13.8587 12 15.2966 10.3711 15.0661 8.52703L14.5002 4M9.5002 4H6.70577C5.39362 4 4.23372 4.85275 3.84233 6.10517L3.17593 8.23768C2.59278 10.1038 3.98689 12 5.94195 12C7.40345 12 8.63624 10.9117 8.81751 9.46151L9.5002 4ZM14.5002 4H17.2946C18.6068 4 19.7667 4.85275 20.1581 6.10517L20.8245 8.23768C21.4076 10.1038 20.0135 12 18.0585 12C16.597 12 15.3642 10.9117 15.1829 9.46151L14.5002 4Z"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export function TemplatesSection() {
  ...
  const [selectedTemplateId, setSelectedTemplateId] =
    useState<TemplateId>("ai-automation");
  const [activePageIndex, setActivePageIndex] = useState(0);
  const [hoveredDesktopPageIndex, setHoveredDesktopPageIndex] = useState<
    number | null
  >(null);
  ...
  const selectedTemplate = useMemo<TemplateCategory>(
    () =>
      TEMPLATE_CATEGORIES.find((item) => item.id === selectedTemplateId) ??
  ...
  const orderedPageIndexes = useMemo(() => {
    ...
    return [
      activePageIndex,
      ...allIndexes.filter((index) => index !== activePageIndex),
    ];
  }, [selectedTemplate.pages, activePageIndex]);
  const pagePositionByIndex = useMemo(
    () =>
      new Map(
        orderedPageIndexes.map((pageIndex, position) => [pageIndex, position]),
      ),
    [orderedPageIndexes],
  );
  ...
  return (
    <>
      <div className="hidden md:flex justify-center bg-[#151515]">
        ...
        >
          <path
            d="M3 54v-8c0-8.837 7.163-16 16-16h318c8.837 0 16-7.163 16-16V6m0 30v16m350 2v-8c0-8.837-7.163-16-16-16H369c-8.837 0-16-7.163-16-16V6"
            stroke="#666"
          />
      ...
      <section
        id="templates"
        className="relative hidden md:block min-h-screen snap-start bg-[#151515] py-16 md:py-20 xl:py-24 overflow-x-hidden"
      >
        <div className="relative z-10 w-[92%] md:w-[88%] lg:w-[90%] mx-auto">
          <div className="flex flex-col items-center">
            <motion.div
              ...
              className="flex h-8 items-center gap-2 rounded-[11px] border border-[#F04D26] bg-[#F04D26]/5 px-2.5 text-xs font-medium text-white/75 shadow-[0_8px_24px_-14px_rgba(0,0,0,0.6)]"
            >
              <svg
                aria-hidden="true"
                width="16px"
            ...
            <motion.h2
              ...
              transition={
                shouldReduceMotion
                  ? { duration: 0 }
                  : { ...entranceTransition, delay: 0.06 }
              }
              className="mt-4 text-center text-pretty font-serif italic text-[#7D7D87] text-xl md:text-2xl 2xl:text-3xl leading-tight xl:whitespace-nowrap"
            >
          ...
          <motion.div
            ...
            transition={
              shouldReduceMotion
                ? { duration: 0 }
                : { ...entranceTransition, delay: 0.12 }
            }
            className="mx-auto mt-8 hidden w-full max-w-3xl flex-wrap justify-center gap-2.5 md:flex xl:gap-3.5"
          >
            {visibleTemplates.map((template) => {
              ...
              return (
                <motion.button
                  ...
                  whileHover={
                    template.disabled || shouldReduceMotion
                      ? undefined
                      : { y: -2, scale: isActive ? 1.01 : 1.005 }
                  }
                  whileTap={shouldReduceMotion ? undefined : { scale: 0.97 }}
                  transition={tabTransition}
                  className={`group relative flex h-11 items-center gap-2.5 rounded-[13px] border px-3 text-sm transition duration-200 active:scale-[0.97] ${
                    template.disabled
                ...
                >
                  <span
                    className="relative z-10 flex h-6 w-6 items-center justify-center rounded-[7px] border border-white/10"
                    style={{ backgroundColor: template.soft }}
                  >
                    <span className="text-white/85">
                      {CATEGORY_ICONS[template.id]}
                    </span>
                  </span>
                  <span className="relative z-10 pr-0.5">{template.label}</span>
                  {template.status === "NEW" && (
                    <span className="relative z-10 rounded-full bg-[#22C55E]/20 px-1.5 py-0.5 text-[10px] font-semibold text-[#22C55E]">
                      NEW
                    </span>
                  )}
                  {template.status === "SOON" && (
                    <span className="relative z-10 rounded-full bg-white/10 px-1.5 py-0.5 text-[10px] font-semibold text-white/55">
                      SOON
                    </span>
                  )}
                </motion.button>
          ...
          <div className="relative mt-3 hidden md:block">
              ...
              <motion.div
                ...
                exit={{
                  ...
                  transition: shouldReduceMotion
                    ? { duration: 0 }
                    : {
                        duration: TAB_FADE.exitDuration,
                        ease: TAB_FADE.exitEase,
                      },
                }}
                transition={
                  shouldReduceMotion
                    ? { duration: 0 }
                    : {
                        duration: TAB_FADE.enterDuration,
                        ease: TAB_FADE.enterEase,
                      }
                }
              >
                <div className="relative z-0 max-h-[85vh] overflow-hidden pb-20">
                  <div className="relative mx-auto grid w-full max-w-6xl 2xl:max-w-[1280px] grid-cols-[minmax(0,1fr)] justify-items-center pt-[7.25rem] [perspective:10000px]">
                    {selectedTemplate.pages.map((page, pageIndex) => {
                      ...
                      const index =
                        pagePositionByIndex.get(pageIndex) ?? pageIndex;
                      const widths = ["100%", "94%", "88%"];
                      const offset = index * -65;
                      const hoverLift =
                        hoveredDesktopPageIndex === pageIndex ? -12 : 0;
                      return (
                        <button
                          key={page.title}
                          type="button"
                          ...
                          onMouseEnter={() =>
                            setHoveredDesktopPageIndex(pageIndex)
                          }
                          onMouseLeave={() => setHoveredDesktopPageIndex(null)}
                          className={`origin-top text-left [grid-area:1/1] transition-[transform,width] duration-350 ease-[cubic-bezier(0.22,1,0.36,1)] ${index === 0 ? "cursor-default" : "cursor-pointer active:scale-[0.97]"}`}
                          style={{
                          ...
                          <motion.div
                            ...
                            transition={
                              shouldReduceMotion
                                ...
                                : {
                                    ...TAB_CARDS.spring,
                                    delay: pageIndex * TAB_CARDS.stagger,
                                  }
                            }
                          >
                            <div
                              className={`w-full origin-top select-none overflow-hidden rounded-t-[22px] bg-[#1E1E1E] transition-all duration-350 ease-[cubic-bezier(0.22,1,0.36,1)] ${index === 0 ? "shadow-[0_22px_44px_-24px_rgba(0,0,0,0.95)]" : ""}`}
                            >
                              <div className="flex items-center bg-[#1E1E1E] px-3.5 py-2.5">
                                <div className="flex min-w-0 items-center gap-2.5">
                                  <div
                                    className="flex h-[22px] w-[22px] items-center justify-center rounded-[7px] border border-white/10"
                                    style={{
                                      backgroundColor: selectedTemplate.soft,
                                    }}
                                  >
            ...
            <div className="absolute bottom-28 left-1/2 z-[60] isolate -translate-x-1/2">
              <div className="rounded-[18px] bg-black/30 p-1 backdrop-blur-md">
                <Link
                  href="/home/templates"
                  onMouseEnter={prewarmTemplatesNavigation}
                  onFocus={prewarmTemplatesNavigation}
                  onTouchStart={prewarmTemplatesNavigation}
                  className="group inline-flex h-11 items-center gap-2.5 rounded-[13px] border border-[#F04D26] bg-[#F04D26] px-[18px] text-sm font-medium text-white whitespace-nowrap shadow-[0_12px_28px_-18px_rgba(240,77,38,0.95)] transition duration-200 ease-out active:scale-[0.97] hover:bg-[#de4723]"
                >
                  ...
                  <motion.div
                    ...
                    animate={
                      tickerWidth !== undefined
                        ? { width: tickerWidth }
                        : undefined
                    }
                    transition={
                      shouldReduceMotion ? { duration: 0 } : BUTTON.widthSpring
                    }
                  >
                    <span
                        ...
                        <motion.span
                          ...
                          transition={
                            shouldReduceMotion
                              ...
                              : {
                                  duration: BUTTON.duration,
                                  ease: BUTTON.easeEnter,
                                }
                          }
                          className="[grid-area:1/1] text-white/70 whitespace-nowrap"
      ...
      <div className="hidden md:flex justify-center bg-[#151515]">
        ...
        >
          <path
            d="M705.5 6v8c0 8.837-7.163 16-16 16h-318c-8.837 0-16 7.163-16 16v8m0-30V8M5.5 6v8c0 8.837 7.163 16 16 16h318c8.837 0 16 7.163 16 16v8"
            stroke="#666"
          />
          <rect
            x="358.5"
