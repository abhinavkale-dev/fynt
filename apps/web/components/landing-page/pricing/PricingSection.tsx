...
export function PricingSection() {
  ...
  return (
    <>
      <section
        id="pricing"
        className="relative bg-[#151515] py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28"
      >
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="my-12">
              <div className="relative mx-auto grid w-fit grid-cols-2 rounded-full bg-[#1E1E1E] p-1">
                <div
                  aria-hidden="true"
                  className={`pointer-events-none absolute top-1 bottom-1 left-1 w-[calc(50%-0.25rem)] rounded-full bg-[#2A2A2A] border border-[#333333] shadow transition-transform duration-500 ease-in-out ${period === "monthly" ? "translate-x-0" : "translate-x-full"}`}
                />
                <button
                  className={`relative z-10 h-8 w-20 sm:w-22 md:w-24 rounded-full text-sm transition-colors ${period === "monthly" ? "text-white font-medium" : "text-[#7D7D87]"}`}
                  onClick={() => setPeriod("monthly")}
                >
                  Monthly
                </button>
                <button
                  className={`relative z-10 h-8 w-20 sm:w-22 md:w-24 rounded-full text-sm transition-colors ${period === "annually" ? "text-white font-medium" : "text-[#7D7D87]"}`}
              ...
              <div className="mt-3 text-center text-xs">
                <span className="text-[#F04D26] font-medium">Save 25%</span>{" "}
                <span className="text-[#7D7D87]">On Annual Billing</span>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 items-start">
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <div className="min-h-[72px]">
                      ...
                      >
                        ...
                        <NumberFlow
                          value={prices.free[period]}
                          className="text-white"
                          style={{ lineHeight: 1, fontSize: 30 }}
                        />
                      </div>
                      <div className="text-[#7D7D87] text-sm mt-2">
                        Per month
                      </div>
                    </div>
                    <a
                      className="inline-flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors h-9 px-4 py-2 bg-[#1E1E1E] hover:bg-[#2A2A2A] border border-[#333333] hover:border-[#F04D26] text-[#E5E5E5] cursor-pointer"
                      href="#"
                    >
                      Get Started
                    </a>
                ...
                <div className="p-8 bg-[#1A1A1A] mx-1 rounded-lg ring-1 ring-[#333333] shadow-xl flex flex-col h-full">
                  <div className="flex-1 space-y-6">
                    ...
                    <a
                      className="inline-flex w-full items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors h-9 px-4 py-2 bg-[#F04D26] hover:bg-[#F04D26]/90 text-white shadow-md border-[0.5px] border-white/10 cursor-pointer"
                      href="#"
                    >
                      Get Started
                    </a>
