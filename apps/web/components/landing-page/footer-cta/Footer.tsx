...
export function Footer() {
    ...
    return (<footer className="relative pt-8 pb-0 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative z-10 text-center mb-8 pb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-white mb-5">
            Design & developed by <span className="text-white/70">@Abhinavstwt</span> 
          </h2>
          
          
          <div className="flex justify-center gap-3">
            <a href="https://twitter.com/fynt" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" fill="white"/>
              </svg>
            </a>
            <a href="https://github.com/fynt" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Collapsible>
              ...
              <CollapsibleContent className="pb-5">
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="https://github.com/fynt" className="text-white/60 hover:text-white text-sm transition-colors block">
                      GitHub
                    </a>
                  </li>
                  <li>
          ...
          <div className="hidden xl:flex justify-center items-start gap-12 mb-1">
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="https://github.com/fynt" className="text-white/60 hover:text-white text-sm transition-colors">
                    GitHub
                  </a>
                </li>
                <li>
