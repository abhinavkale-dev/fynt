...
export function BentoGrid() {
  return (
    <div className="relative z-10 w-full max-w-[1200px] xl:max-w-[1240px] 2xl:max-w-[1400px] min-[120rem]:max-w-[1520px] mx-auto px-2 sm:px-3 md:px-4 lg:px-0">
      <div className="grid items-start grid-cols-1 lg:grid-cols-[1.12fr_1fr_1.12fr] xl:grid-cols-[1.1fr_1fr_1.1fr] gap-4 md:gap-5 lg:gap-3 xl:gap-4 2xl:gap-5">
        ...
        <div className="flex flex-col gap-4 md:gap-5 lg:gap-3 xl:gap-4 2xl:gap-5">
          ...
          <BentoShell
            outerRadius="rounded-[36px] sm:rounded-[40px] lg:rounded-[48px] xl:rounded-[58px]"
            midRadius="rounded-[33px] sm:rounded-[37px] lg:rounded-[45px] xl:rounded-[55px]"
            innerRadius="rounded-[30px] sm:rounded-[34px] lg:rounded-[42px] xl:rounded-[52px]"
          >
            <F3AIModels />
          </BentoShell>
        </div>
