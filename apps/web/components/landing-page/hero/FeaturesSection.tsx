...
export function FeaturesSection() {
  return (
    <section
      id="features"
      className="relative min-h-screen bg-[#151515] py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20 2xl:py-24 snap-start flex flex-col justify-center"
    >
          ...
          >
            <g>
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M20 15C15.1389 15 13 17.1389 13 22C13 17.1389 10.8611 15 6 15C10.8611 15 13 12.8611 13 8C13 12.8611 15.1389 15 20 15Z"
                stroke="currentColor"
                strokeWidth="2"
