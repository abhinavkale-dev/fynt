  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-center items-center gap-3 z-10 pointer-events-none">
      <DrawerTrigger asChild>
        <motion.div
          initial={{ opacity: 0, scale: CARD_ANIM.initialScale }}
          animate={{
            opacity: 1,
            scale: 1,
        ...
        >
          <Card
            className="card hover:shadow-lg transition-shadow cursor-pointer border-2 border-dashed border-white/50 hover:border-white/80 h-[100px] w-[100px] p-4 flex flex-col justify-center items-center"
      ...
      <motion.p
        ...
        transition={{ delay: TIMING.textDelay, duration: 0.2, ease: "easeOut" }}
        className="text-sm text-white/70 pointer-events-auto"
      >
