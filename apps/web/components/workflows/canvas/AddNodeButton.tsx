  ...
  return (
    ...
    >
      <DrawerTrigger asChild>
        <button
          className="relative rounded-full bg-white/10 hover:bg-white/20 p-3 transition-[background-color,transform] duration-150 ease-out shadow-lg border border-white/20 active:scale-[0.93]"
          aria-label="Add node"
        >
          {showPulse && (
            <span
