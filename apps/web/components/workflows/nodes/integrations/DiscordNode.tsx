...
function getSubtitle(data: DiscordNodeData, isConfigured: boolean): string {
  ...
  if (noCredential && noContent) return "Add credential & message";
  if (noCredential) return "Add credential";
  if (noContent) return "Add message content";
