...
export default function SignInPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Enter your credentials to access your workflows"
      marketingTitle="Welcome back to Fynt"
    ...
    >
      ...
      <form
        ...
        className="auth-form space-y-5 lg:space-y-4"
      >
        <AnimatePresence>
          {error && (
            <motion.div
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-end">
            <button
              type="button"
              className="text-sm text-[#F04D26] hover:text-[#E63D00] transition-colors"
            >
              Forgot password?
            </button>
          </div>
      ...
      <div className="auth-switch mt-6 lg:mt-5 text-center">
        ...
        <Link
          href="/signup"
          className="text-[#F04D26] hover:text-[#E63D00] text-sm font-medium transition-colors"
        >
          Sign up
        </Link>
      </div>
