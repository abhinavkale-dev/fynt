  ...
  return (
    <header className="relative flex h-16 shrink-0 items-center gap-2 border-b px-4">
      ...
      <div className="flex items-center gap-2 flex-1">
        <Link
          href="/home"
          className="flex items-center gap-2 hover:bg-white/5 rounded-md px-2 py-1 -ml-2 transition-colors duration-150 ease group"
        >
          ...
          <span className="text-sm font-medium text-white/50 group-hover:text-white transition-colors duration-150 ease">
            Personal
          </span>
        </Link>
        ...
        {isEditingTitle ? (
          <input
            ...
            onBlur={onTitleSave}
            className="bg-transparent border-none outline-none text-white font-medium text-sm flex-1 min-w-0"
            maxLength={128}
            name="workflowTitle"
            autoComplete="off"
          />
          ...
          <span
            ...
            className="text-sm font-medium text-white cursor-pointer hover:text-white/80 transition-colors duration-150 ease"
      ...
      <div className="flex items-center gap-3">
        ...
        {currentWorkflowId === "new" && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-[#F04D26] hover:bg-[#F04D26]/90 disabled:bg-[#F04D26]/50 text-white rounded-md text-sm transition-colors duration-150 ease active:scale-[0.97]"
            title="Save workflow"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
