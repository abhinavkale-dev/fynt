...
export default function WorkflowNotFound() {
    return (<main className="min-h-screen bg-[#151515] text-[#F7F8F8] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.005))] p-8 text-center shadow-[0_20px_40px_-12px_rgba(0,0,0,0.45)]">
        ...
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-white/50">Invalid Workflow Link</p>
        <h1 className="mt-2 text-3xl font-bold text-white">This workflow URL is not valid</h1>
        <p className="mt-3 text-sm text-white/60">
          The link may include extra characters or spaces. Please open the workflow from your dashboard.
        </p>
